		...
		<%@include file="common2.jsp" %><div class="main-content">
						...
						<div class="icon-collection">
							<section id="web-application">
								<div class="fontawesome-icon-list">
									<div class="fa-hover"><i class="fa fa-plus-square" onclick="addClassroom()"></i> <span>增加教室</span></div>
								</div>
							</section>
						</div>
					</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body" >
					 <table id="classroomid" style="display:none;"></table>		
				</div>
			</div>
...
function addClassroom(){
		 window.location.href="addClassroom.jsp";
		}
...
<script type="text/javascript" src="flexigrid_my/jquery-1.3.2.min.js"></script>
		...
		<script type="text/javascript" src="flexigrid_my/classroomList.js"></script>
</html>