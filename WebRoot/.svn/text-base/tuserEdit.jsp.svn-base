				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">用户修改页面</h3>
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="username" name="username" value="${useredit.user}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="password" class="form-control" id="password" name="password" value="${useredit.pass}">
									</div>
								</div>
								</c:if>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="password" class="form-control" id="password" name="password" value="" onblur="checkPassword();">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control" name="usertype" id="usertype">
										    <option value="${useredit.userType}">
										    ${role.name}</option>
								...
								<div class="form-group">
									<div class="col-sm-10">
									    ...
									    <c:if test="${userType==1}">
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-4" value="保存" onclick="doUserAdd();">
										</c:if>
										<c:if test="${userType!=1}">
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-4" value="保存" onclick="doUserSave();">
										</c:if>
									</div>
								</div>
								
								<div class="form-group-separator"></div>
								<input type="hidden" id="userid" name="userid" value="${useredit.id}"/>
							</form>
						</div>
					</div>
...
function checkPassword(){
	...
	$.post("CheckPassword.action",{userid:userid,password:password},
		function(data){
			if(data=="false"){
			bol="false";
			alert("原密码错误，请重新输入！");
     ...
     if(null == username || username == ''){
      ...
      if(null == usertype || usertype == ''){
        ...
        return false;
				...
				document.forms[0].action = "DoUserAdd.action";
				//alert('用户添加成功');
...
function doUserSave(){
     ...
     var passwordNew = document.getElementById("passwordNew").value;
      ...
      if(null == passwordNew || passwordNew == ''){
        alert('新密码不能为空！');
        return false;
      }
      if(bol=="false"){
