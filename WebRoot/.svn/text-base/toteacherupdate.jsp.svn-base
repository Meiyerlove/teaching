							...
							<form role="form" class="form-horizontal">			
								<div class="form-group">
									...
									<div class="col-sm-10">	
										 ...
										 <input type="text" name="teachername" class="form-control" id="teachername"  readonly="readonly" value="${teacher.name}"/>  
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									  <input type="text" name="teachertid" id="teachertid" class="form-control" readonly="readonly" value="${teacher.tid }">
									</div>
								</div>
								<div class="form-group-separator"></div>
								<div class="form-group">
								...
								<div class="form-group">
								 ...
								 <div class="col-sm-10">
									<input type="text" name="cellphone" id="cellphone" class="form-control" value="${teacher.cellphone}"/>
									</div>
								</div>
								<div class="form-group-separator"></div>
								<div class="form-group">
									...
									<div class="col-sm-10"> 
									  <c:if test="${teacher.sex==1}">
									     <input type="radio" name="sex"  checked="checked" value="1" style="margin-top:10px"/>男
									     <input type="radio" name="sex"  value="2" style="margin-top:10px; margin-left:30px"/>女
									  </c:if>
									   <c:if test="${teacher.sex==2}">
									     <input type="radio" name="sex"  value="1" style="margin-top:10px"/>男
									     <input type="radio" name="sex"  value="2" checked="checked" style="margin-top:10px;margin-left:30px"/>女
									  </c:if>
									</div> 
								</div>
								<div class="form-group-separator"></div>
								<div class="form-group">
									...
									<div class="col-sm-10"> 
									  <c:if test="${teacher._status==1 }">
									     <input type="radio" name="status" id="status" checked="checked" value="1" style="margin-top:10px"/>在职
									     <input type="radio" name="status" id="status" value="2" style="margin-top:10px;margin-left:17px"/>离职
									  </c:if>
									   <c:if test="${teacher._status==2 }">
									     <input type="radio" name="status" id="status" value="1" style="margin-top:10px"/>在职
									     <input type="radio" name="status" id="status" value="2" checked="checked" style="margin-top:10px;margin-left:17px"/>离职
									  </c:if>
									</div> 
								</div>
								...
								<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="修改" onclick="doUpdateacher();">
									</div>
								</div>
