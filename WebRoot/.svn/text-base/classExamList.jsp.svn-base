	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<%@include file="common.jsp" %><div class="main-content">
			...
			<div class="panel panel-default">
				...
				<input type="hidden" name="tclassid" id="tclassid" value="${tclassid}"/>
				 <div style="float:left; margin-left:10px;height:12px;">导出成绩:
...
<script type="text/javascript">
  function exportExcelClassResult(){
       $.post("ExportExcelClassResult.action",{tclassid:$("#tclassid").val()},  
         function(data){
		 var obj=eval("("+data+")");
		  if(!obj.bol){
