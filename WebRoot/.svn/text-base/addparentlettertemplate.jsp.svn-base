		...
		<%@include file="common.jsp" %><div class="main-content">
			...
			<div class="panel panel-default" style="height:800px;">
				...
				<div class="title" style="margin-top:50px;">
				   <strong>家长信标题:</strong>  
				  <input type="text" id="title" name="title"  style="width:785px"; placeholder="最多可输入20个字符"  maxlength='20' >
				</div>
				
				 <div style="margin-top:142px">
				     <strong>家长信内容:</strong>
				 </div> 
				 <div style="margin-top:-130px;margin-left:75px;width:800px;height: 450px";>
				   <!-- <textarea id="content" name="content" rows="8" cols="20" class="ckeditor"></textarea> -->
				   <textarea cols="80" id="editor1" name="editor1"  rows="10"></textarea>
				 </div>
						<div class="col-sm-10" style="margin-top:140px">
							...
							<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="保存" onclick="saveTemplate();">
						</div>
...
<script type="text/javascript">
 ...
 function saveTemplate(){
    ...
    var oEditor = CKEDITOR.instances.editor1.getData();
       ...
       document.forms[0].action="ToSaveTemplate.action";
       $("#field-6").attr("disabled","disabled");
       document.forms[0].submit();
 }

function toClassDelete(){
    alert("暂时不做删除业务逻辑");
}
function logout(){
			if (confirm("您确定要退出吗?")){
