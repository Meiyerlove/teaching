							...
							<form role="form" class="form-horizontal">
								...
								<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="保存" onclick="doPunishAdd();">
									</div>
								</div>
...
function logout(){
	...
	function doPunishAdd() {
        ...
        alert('增加处分成功');
		document.forms[0].action = "DoPunishAdd.action";
		//alert('用户添加成功');
		document.forms[0].submit();
	}
</script>
