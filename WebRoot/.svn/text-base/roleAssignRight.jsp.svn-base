		...
		<%@include file="common.jsp" %><div class="main-content">
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading" style="padding-top:10px;">
					<h3 class="panel-title">${role.name}的权限</h3>
				</div>
				...
				<div class="panel-body">
					<table class="table table-bordered table-striped" id="example-2">
						...
						<tbody class="middle-align">
						  <c:forEach items="${rightList}" var="right" varStatus="status">
							<tr>
								<td>
									<input type="checkbox" name="mycheckbox" class="cbr" value="${right.rightcode}" <c:if test="${right.ischecked == 1}"> checked </c:if>>
								</td>
								<td>${right.rightcode}</td>
								<td>${right.righttext}</td>
							</tr>
							</c:forEach>
				...
				<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" value="保存" onclick="doRightAdd();">
									</div>
								</div>
...
function doRightAdd(){
				...
				document.forms[0].action = "DoRightAdd.action";
