				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">增加奖励页面</h3>
							...
							<form role="form" class="form-horizontal">
								...
								<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="保存" onclick="doRewardAdd();">
									</div>
								</div>
...
function logout(){
	...
	function doRewardAdd() {
        ...
        alert('增加奖励成功');
		document.forms[0].action = "DoRewardAdd.action";
		//alert('用户添加成功');
		document.forms[0].submit();
	}
</script>
