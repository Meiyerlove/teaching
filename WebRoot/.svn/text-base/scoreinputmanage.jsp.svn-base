						  ...
						  <c:forEach items="${studentListScore}" var="student" varStatus="status">
							<tr>
								...
								<c:forEach items="${indexList}" var="ind" varStatus="status">
									<c:if test="${ind == 1}">
									 <td>
									  <s:if test="${ind == maxindex}">
									    <c:if test="${exam.scoretype == 1}">
									      <input type="text" name="score${student.sid}" value="${student.score.exam1}">
									    </c:if>
									    <c:if test="${exam.scoretype == 2}">
									    <select class="form-control" name="score${student.sid}" id="score${student.sid}">
										    <option value="${student.score.exam1}">${student.score.exam1}</option>    
											<option value="P">P</option>
											<option value="RW">RW</option>
											<option value="RA">RA</option>
											<option value="Resit/ABS/CHT">Resit/ABS/CHT</option>
									...
									<c:if test="${ind == 2}">
									  <td>
									    <s:if test="${ind == maxindex}">
									    <c:if test="${exam.scoretype == 1}">
									      <input type="text" name="score${student.sid}" value="${student.score.exam2}">
									    </c:if>
									    <c:if test="${exam.scoretype == 2}">
									    <select class="form-control" name="score${student.sid}" id="score${student.sid}">
										    <option value="${student.score.exam2}">${student.score.exam2}</option>    
											<option value="P">P</option>
											<option value="RW">RW</option>
											<option value="RA">RA</option>
											<option value="Resit/ABS/CHT">Resit/ABS/CHT</option>
									 ...
									 <s:if test="${ind == maxindex}">
									    <c:if test="${exam.scoretype == 1}">
									      <input type="text" name="score${student.sid}" value="${student.score.exam3}">
									    </c:if>
									    <c:if test="${exam.scoretype == 2}">
									    <select class="form-control" name="score${student.sid}" id="score${student.sid}">
										    <option value="${student.score.exam3}">${student.score.exam3}</option>    
											<option value="P">P</option>
											<option value="RW">RW</option>
											<option value="RA">RA</option>
											<option value="Resit/ABS/CHT">Resit/ABS/CHT</option>
									  ...
									  <td>
									    <s:if test="${ind == maxindex}">
									    <c:if test="${exam.scoretype == 1}">
									      <input type="text" name="score${student.sid}" value="${student.score.exam4}">
									    </c:if>
									    <c:if test="${exam.scoretype == 2}">
									    <select class="form-control" name="score${student.sid}" id="score${student.sid}">
										    <option value="${student.score.exam4}">${student.score.exam4}</option>    
											<option value="P">P</option>
											<option value="RW">RW</option>
											<option value="RA">RA</option>
											<option value="Resit/ABS/CHT">Resit/ABS/CHT</option>
									  ...
									  <td>
									    <s:if test="${ind == maxindex}">
									    <c:if test="${exam.scoretype == 1}">
									      <input type="text" name="score${student.sid}" value="${student.score.exam5}">
									    </c:if>
									    <c:if test="${exam.scoretype == 2}">
									    <select class="form-control" name="score${student.sid}" id="score${student.sid}">
										    <option value="${student.score.exam5}">${student.score.exam5}</option>    
											<option value="P">P</option>
											<option value="RW">RW</option>
											<option value="RA">RA</option>
											<option value="Resit/ABS/CHT">Resit/ABS/CHT</option>
									  ...
									  <td>
									    <s:if test="${ind == maxindex}">
									    <c:if test="${exam.scoretype == 1}">
									      <input type="text" name="score${student.sid}" value="${student.score.exam6}">
									    </c:if>
									    <c:if test="${exam.scoretype == 2}">
									    <select class="form-control" name="score${student.sid}" id="score${student.sid}">
										    <option value="${student.score.exam6}">${student.score.exam6}</option>    
											<option value="P">P</option>
											<option value="RW">RW</option>
											<option value="RA">RA</option>
											<option value="Resit/ABS/CHT">Resit/ABS/CHT</option>
									 ...
									 <td>
									    <s:if test="${ind == maxindex}">
									    <c:if test="${exam.scoretype == 1}">
									      <input type="text" name="score${student.sid}" value="${student.score.exam7}">
									    </c:if>
									    <c:if test="${exam.scoretype == 2}">
									    <select class="form-control" name="score${student.sid}" id="score${student.sid}">
										    <option value="${student.score.exam7}">${student.score.exam7}</option>    
											<option value="P">P</option>
											<option value="RW">RW</option>
											<option value="RA">RA</option>
											<option value="Resit/ABS/CHT">Resit/ABS/CHT</option>
									  ...
									  <td>
									    <s:if test="${ind == maxindex}">
									    <c:if test="${exam.scoretype == 1}">
									      <input type="text" name="score${student.sid}" value="${student.score.exam8}">
									    </c:if>
									    <c:if test="${exam.scoretype == 2}">
									    <select class="form-control" name="score${student.sid}" id="score${student.sid}">
										    <option value="${student.score.exam8}">${student.score.exam8}</option>    
											<option value="P">P</option>
											<option value="RW">RW</option>
											<option value="RA">RA</option>
											<option value="Resit/ABS/CHT">Resit/ABS/CHT</option>
				...
				<div class="form-group-separator"></div>
								...
								<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:450px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="保存" onclick="doScoreInputManage();">
