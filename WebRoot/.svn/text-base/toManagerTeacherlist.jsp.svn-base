						...
						<div class="icon-collection">
							<section id="web-application">
								<div class="fontawesome-icon-list">
									<div class="fa-hover"><i class="fa fa-plus-square" onclick="addteacher()"></i> <span>增加老师</span></div>
								</div>
							</section>
						</div>
					</div>
				...
				<div class="col-sm-12">		
					<div class="panel panel-default">
						...
						<div class="panel-body" style="overflow:scroll;">															
						     <table id="teacherid" style="display:none;"></table>
						</div>
						</form>
					</div>
...
function addteacher(){
		 window.location.href="toAddteacher.jsp";
		}
function logout(){
			if (confirm("您确定要退出吗?")){
...
<script type="text/javascript" src="flexigrid_my/jquery-1.3.2.min.js"></script>
		...
		<script type="text/javascript" src="flexigrid_my/teacherList.js"></script>
</html>