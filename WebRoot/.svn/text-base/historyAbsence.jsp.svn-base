		...
		<%@include file="common.jsp" %><div class="main-content">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div style="float:left;width:45%;height:30px;line-height:30px;text-align:right;">迟到：${late}</div>
					<div style="float:left;width:10%;height:30px;line-height:30px;text-align:center;">旷课：${truant}</div>
					<div style="float:left;width:45%;height:30px;line-height:30px;text-align:left;">早退：${early}</div>
...
function toMyKechengList(){
				document.forms[0].action = "ToMyKechengList.action";
				document.forms[0].submit();	
		}
		
function doStatus(absenceid){
                document.getElementById("absenceid").value = absenceid;
				document.forms[0].action = "DoAbsenceStatus.action";
				document.forms[0].submit();	
		}
