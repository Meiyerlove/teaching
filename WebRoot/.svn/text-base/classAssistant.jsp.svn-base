					...
					<div class="panel panel-default">
						...
						<div class="panel-body">						
							<form role="form" class="form-horizontal">
								...
								<div class="col-sm-10">	
									 <input type="text"  class="form-control" value="${cla.cid }" readonly="readonly"/>
									</div>
								 </div>
								...
								<div class="form-group">
								 <label class="col-sm-2 control-label">班级名称:</label>
								<div class="col-sm-10">	
									 <input type="text"  class="form-control" value="${cla.name }" readonly="readonly"/>
									</div>
								 </div>
								<div class="form-group-separator"></div>								
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control" name="assistantid" id="assistantid">
										    <option value="${cla.assistant.id}">${cla.assistant.name}</option>
								...
								<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="保存" onclick="doAdjustClassAssistant()">
									</div>
								</div>
								
								<div class="form-group-separator"></div>
								<input type="hidden" name="classid" value="${cla.id}">
							</form>
						</div>
					</div>
...
function doAdjustClassAssistant(){
				document.forms[0].action = "DoAdjustClassAssistant.action";
				//alert('用户添加成功');
