		...
		<%@include file="common.jsp" %><div class="main-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">学生考试成绩信息</h3>
				</div>
				
				<div class="panel-body" style="overflow: scroll;width:100%;height:500px;">
					<table class="table table-bordered table-striped" id="example-2" style="width:1600px;">
						<thead>
							<tr>
								<th>学生ID</th>
								<th>学生姓名</th>
						...
						<tbody class="middle-align">
						 <c:forEach items="${_list}" var="scorenew" varStatus="status">
							<tr>
								...
								<td>${scorenew.title}</td>
								<td>${scorenew.subjectname}</td>
...
function toStudentDetail(studentid){
                document.getElementById("studentid").value = studentid;
				document.forms[0].action = "ToStudentDetail.action";
				document.forms[0].submit();	
		}
