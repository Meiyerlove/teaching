		...
		<%@include file="common.jsp" %><div class="main-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">学生课表</h3>
				</div>
				<c:if test="${not empty kechengVersionList}">
				<div class="panel-heading" style="float:right;">
					<select id="version" name="version" onchange="findStudentKebiaoListByVersion();">
...
function findStudentKebiaoListByVersion(){
				document.forms[0].action = "FindStudentKebiaoListByVersion.action";
				document.forms[0].submit();	
}		
</script>
</html>