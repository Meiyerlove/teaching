	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<%@include file="common.jsp" %><div class="main-content">
			...
			<div>
					...
					<table class="table table-bordered table-striped" id="example-2" style="width:1040px;margin-top:-20px;z-index:-100;">
								<thead>
									<tr>
										<th width="20%">学生名字</th>
										<th width="20%">学号</th>
										<th width="30%">考试班级</th>							
										<th width="30%">${exam.examTypeName}</th>							
										</tr>
								</thead>
								...
								<tbody class="middle-align">
								  <c:forEach items="${studentList}" var="student" varStatus="status">
									<tr>
										...
										<td>
											<input class="form-control" value="${student.tempResult}" readonly style="width:200px;display:inline;background-color:#FFF;"/>
											
											<c:if test="${not empty student.tempzk}">
											  (${student.tempzk})	
											</c:if>											
										</td>	
									</tr>
							...
							<div class="form-group" style="margin-top:80px;">
								<div class="col-sm-10">
									   <input type="button" class="form-control" style="margin-left:200px;width:80px;background:#e4393c;color:white;" value="退回" onclick="returnScore('${exam.id}');">
										<input type="button" class="form-control" style="margin-left:450px;width:130px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="提交至教务" onclick="submitScore('${exam.id}');">								
								</div>
							</div>
					</div>
			</div>
...
function returnScore(examid){
				$("#examid").val(examid);
				document.forms[0].action = "ReturnScore.action";
				document.forms[0].submit();	
		}
function submitScore(examid){
				$("#examid").val(examid);
				document.forms[0].action = "SubmitScore.action";
				document.forms[0].submit();	
		}
