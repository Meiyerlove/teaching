				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">增加处分页面</h3>
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="sid" name="sid" value="${punish.sid }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="name" name="name" value="${punish.name }">
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">处分名称</label>
									
									<div class="col-sm-10">
										<input type="text" class="form-control" id="title" name="title" value="${punish.title }">
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">处分事由</label>
									
									<div class="col-sm-10">
										<textarea class="form-control" id="reason" name="reason">${punish.reason }</textarea>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="保存" onclick="doPunishUpdate();">
									</div>
								</div>
								
								<div class="form-group-separator"></div>
								<input type="hidden" name="punishid" id="punishid" value="${punish.id }">
							</form>
						</div>
					</div>
...
function logout(){
	...
	function doPunishUpdate() {
        ...
        alert('更新处分成功');
		document.forms[0].action = "DoPunishUpdate.action";
		//alert('用户添加成功');
		document.forms[0].submit();
	}
</script>
