...
public class TestGetPost {
	...
	public static void main(String args[]) {
		...
		// 发送GET请求
		// String s =
		// TestGetPost.sendGet("http://localhost:8888/abc/login.jsp",null);
		// System.out.println(s);
		// 发送POST请求test.wesufe.cn/weixin/notify
		// String s1 =
		// TestGetPost.sendPost("http://localhost:8888/abc/a.jsp","user=李刚&pass=abc");
		String s1 = TestGetPost.sendPost("http://test.wesufe.cn/weixin/notify",
				"title=测试标题&content=测试内容");
		// String s1 =
		// TestGetPost.sendPost("http://localhost:8080/teachingd","user=李刚&pass=abc");
