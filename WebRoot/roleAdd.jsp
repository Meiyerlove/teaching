				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">增加角色页面</h3>
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="rolename" name="rolename" placeholder="请输入名称">
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-2">角色名称描述</label>
									
									<div class="col-sm-10">
										<input type="text" class="form-control" id="roledesc" name="roledesc" placeholder="请输入描述">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="保存" onclick="doRoleAdd()">
									</div>
								</div>
     ...
     if(null == name || name == ''){
      ...
      if(null == desc || desc == ''){
        ...
        return false;
				...
				document.forms[0].action = "DoRoleAdd.action";
