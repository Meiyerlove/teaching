  ...
  <tr>
    <td height="600" colspan="2" valign="top">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="2" align="center" class="title"> &nbsp;&nbsp;评教卷
          </td>
        </tr>
        <tr>
          <td width="64%">&nbsp;</td>
          <td width="36%">&nbsp;满分<font color="red">100</font>分&nbsp;&nbsp;&nbsp;<font color="red"></font></td>
        </tr>
      </table>
...
<table id="single" width="90%"  border="0" cellspacing="0" cellpadding="0" align=center>
  ...
  <tr>
    <td colspan="4" height=23 style="font-size:11pt;">一、（<font color=red>共10题，每题10分，A(10分)--B(7分)--C(4分)--D(1分)</font>）</td>
  </tr>
<logic:iterate id="questions" name="singleQue" type="com.wgh.actionForm.QuestionsForm" scope="request" indexId="ind">
  ...
  <tr>
    ...
    <td width="86%" align=left nowrap><bean:write name="questions" property="optionD" filter="true"/></td>
        ...
        <tr>
		  <td align="center"><input type="hidden" name="examid" value="${examid}"><html:button property="button" styleClass="btn_grey" value="交卷" onclick="doSubmit();"/>		  </td>
        </tr>
      </table>
	  </html:form>
	  </td>
