					...
					<table class="table table-bordered table-striped" id="example-2">
						...
						<tbody class="middle-align">
						  <c:forEach items="${studentList}" var="student" varStatus="status">
							<tr>
							    <td>
									<input type="checkbox" name="checkbox1" class="cbr" value="${student.sid}">
								</td>
								<td>${student.sid}</td>
								<td>${student.name}</td>
			                 ...
			                 <div class="form-group" style="margin-top:15px;">
									<label class="col-sm-2 control-label"  style="margin-top:8px;">留级班级名称</label>
									
									<div class="col-sm-10">
										<input type="text" class="form-control" id="liujiclassname" name="liujiclassname">
									</div>
		                 	</div>
				            <br/><br/>
				              <div class="form-group-separator" style="clear:both;margin-top:10px;"></div>						
				             <div class="form-group" style="margin-top:10px;">
									<label class="col-sm-2 control-label"  style="margin-top:8px;">家长信内容</label>
									
									<div class="col-sm-10">
										<textarea class="form-control" id="jzx" name="jzx"></textarea>
									</div>
				                  </div>	
				        <div class="form-group">
									<div class="col-sm-10" style="margin-top:10px;">
									  ...
									  <input type="button" class="form-control" style="margin-left:550px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="提交" onclick="doLiuji();">
									<!--
...
function doLiuji(){
		...
		var liujiclassname = document.getElementById("liujiclassname").value;
        if(null == liujiclassname || liujiclassname == ''){
           alert('留级班级名字不能为空！');
           return false;
           }
        var jzx = document.getElementById("jzx").value;
        if(null == jzx || jzx == ''){
           alert('家长信内容不能为空！');
           return false;
           }
				document.forms[0].action = "DoLiuji.action";
				document.forms[0].submit();	
  }
