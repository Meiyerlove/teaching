				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">评教增加页面</h3>
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal">
								<div class="form-group">
									<label class="col-sm-2 control-label"  >评教名称</label>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">需评老师</label>
     ...
     if(null == title || title == ''){
      ...
      if(null == subjectname || subjectname == ''){
        ...
        return false;
				...
				document.forms[0].action = "DoExampjAdd.action";
				alert('评教添加成功');
