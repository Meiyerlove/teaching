						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="username" name="username" value="${student.user}" readonly style="background-color:#FFFFFF">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="password" class="form-control" id="password" name="password" value="${student.pass}">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-4" value="保存" onclick="doStudentModify();">
									</div>
								</div>
...
function doStudentModify(){
     var password = document.getElementById("password").value;
      if(null == password || password == ''){
        alert('密码不能为空！');
        return false;
      }
				document.forms[0].action = "DoStudentModify.action";
				//alert('用户添加成功');
