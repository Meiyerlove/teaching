				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">课程版本新增</h3>
						</div>
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal">
								...
								<!-- <div class="form-group">
									...
									<div class="col-sm-10">
									   <input type="text" name="createid" id="createid" />   
									</div>
								</div> -->
								<!-- <div class="form-group-separator"></div> -->
								<!-- <div class="form-group">
									...
									<div class="col-sm-10">
									   <input type="text" name="createdate" id="createdate" class="Wdate" style="margin-top:3px;height:26px;"
									         onClick="WdatePicker()" >
								...
								<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="新增" onclick="doAdjustAdd();">
									</div>
								</div>
