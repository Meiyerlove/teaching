		...
		<%@include file="common.jsp" %><div class="main-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">批量分班学生信息导入页面</h3>
				</div>
				
				<div class="panel-body">	
				</div>
			</div>
			<div><table><tr><td width=150>请选择要导入的文件:</td><td width=150><input type="file" name="upload"></td><td width=150>(文件格式为*.xls)</td><td width=150><input type="button" name="button1" value="学生数据导入" onclick="distributeClass();"></td></tr></table></div>
			<!-- Main Footer -->
...
function distributeClass(){
				document.forms[0].action = "DistributeClass.action";
				document.forms[0].submit();	
		}
