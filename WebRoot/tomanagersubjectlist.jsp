			...
			<div class="row">
						...
						<div class="icon-collection">
							<section id="web-application">
								<div class="fontawesome-icon-list">
									<div class="fa-hover"><i class="fa fa-plus-square" onclick="addsubject()"></i> <span>增加课程库</span></div>
								</div>
							</section>
						</div>
					</div>
			 ...
			 <div class="panel panel-default" style="min-height:600px;">
				<div class="panel-heading">
					<h3 class="panel-title">课程库列表</h3>
				</div>
				<div class="panel-body">
					 <table id="subjectid" style="display:none;"></table>		
				</div>
			</div> 
...
function addsubject(){
		 window.location.href="toAddsubject.jsp";
		}
...
function logout(){
      ...
      <script type="text/javascript" src="flexigrid_my/jquery-1.3.2.min.js"></script>
       ...
       <script type="text/javascript" src="flexigrid_my/subjectList.js"></script>
