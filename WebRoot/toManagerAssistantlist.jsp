		...
		<%@include file="common.jsp" %><div class="main-content">
						...
						<div class="icon-collection">
							<section id="web-application">
								<div class="fontawesome-icon-list">
									<div class="fa-hover"><i class="fa fa-plus-square" onclick="addAssistant()"></i> <span>增加辅导员</span></div>
								</div>
							</section>
						</div>
					</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">辅导员列表</h3>
				</div>
				<div class="panel-body" style="overflow:scroll;width:100%;" >
					 <table id="assistantid" style="display:none;"></table>		
				</div>
			</div>
...
function addAssistant(){
		 window.location.href="addAssistant.jsp";
		}
		
function toAssistantUpdate(aid){
       $("#assistantid").val(aid);
       document.forms[0].action="ToAssistantUpdate.action";
...
<script type="text/javascript" src="flexigrid_my/jquery-1.3.2.min.js"></script>
		...
		<script type="text/javascript" src="flexigrid_my/assistantList.js"></script>
</html>