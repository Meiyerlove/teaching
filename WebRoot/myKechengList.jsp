...
<form enctype="multipart/form-data" method="post">
		...
		<%@include file="common.jsp" %><div class="main-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">课程表数据管理</h3>
				</div>
				
				<div class="panel-body" style="overflow:scroll;width:100%;height:500px;z-index:-100;">
					<table class="table table-bordered table-striped" id="example-2" style="width:1550px;margin-top:-20px;z-index:-100;">
						<thead>
							<tr>
								<th>操作</th>
								<th>ID</th>
						...
						<tbody class="middle-align">
						  <c:forEach items="${kechengList}" var="kecheng" varStatus="status">
							<tr>
							   <td> 
									<a href="javascript:toKaoqin('${kecheng.id}','${tuser.userType}');" class="btn btn-secondary btn-sm btn-icon icon-left">
										开始考勤
									</a>		  
								</td>
								<td>${kecheng.id}</td>
						 ...
						 <%--  <c:forEach items="${kechengList2}" var="kecheng" varStatus="status">
							<tr>
								<td>${kecheng.id}</td>
								<td>${kecheng.grade}</td>
								<td>${kecheng.classname}</td>
								...
								<td>${kecheng.week}</td>
								<td>
									<a href="javascript:toKaoqin('${kecheng.id}',2);" class="btn btn-secondary btn-sm btn-icon icon-left">
										开始考勤
									</a>
								</td>
							</tr>
	...
	<input type="hidden" name="agers" id="agers" value=""/>
</form>
</body>
...
function toKaoqin(kechengid,agers){
                document.getElementById("kechengid").value = kechengid;
                document.getElementById("agers").value=agers;
				document.forms[0].action = "ToKaoqin.action";
				document.forms[0].submit();	
		}
