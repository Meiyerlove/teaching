						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="cellphone" name="cellphone" value="${student.cellphone}" readonly style="background-color:#FFFFFF;">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<div class="radio">
											<label>
												<input type="radio" name="sex" checked value="1" disabled>
												男
											</label>
										</div>
										<div class="radio">
									...
									<c:if test="${student.sex == 2}">
										<div class="radio">
											<label>
												<input type="radio" name="sex" checked value="2" disabled>
												女
											</label>
										</div>
										<div class="radio">
											<label>
												<input type="radio" name="sex" value="1" disabled>
												男
											</label>
										</div>
									</c:if>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="a_cellphone" name="a_cellphone" value="${aa.cellphone}">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="oph" name="oph" value="${aa.oph}">
									</div>
								</div>
								<div class="form-group-separator"></div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="majorname" name="majorname" value="${student.majorname}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="jzfname" name="jzfname" value="${student.jzfname}" readonly style="background-color:#FFFFFF;">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="jzfcellphone" name="jzfcellphone" value="${student.jzfcellphone}" readonly style="background-color:#FFFFFF;">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="jzmname" name="jzmname" value="${student.jzmname}" readonly style="background-color:#FFFFFF;">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="jzmcellphone" name="jzmcellphone" value="${student.jzmcellphone}" readonly style="background-color:#FFFFFF;">
									</div>
								</div>
								<div class="form-group">
