				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">调课记录表</h3>
							
						</div>
						<!-- style="overflow:scroll;height:500px;z-index:-100;"width:1600px;margin-top:-20px;z-index:-100; -->
						<div class="panel-body" style="overflow:scroll;">
					     <table id="flexs" style="display:none;"></table>
						</div>
					</div>			
				</div>
			</div>
...
<script type="text/javascript">
		...
		<script type="text/javascript" src="flexigrid_my/t_test.js"></script>
