						...
						<tbody class="middle-align" id="middle-align">
						  <c:forEach items="${studentList}" var="student" varStatus="status">
							<tr>
								...
								<td>
									<a href="javascript:toStudentHistoryInfomationList('${student.id}');" class="btn btn-secondary btn-sm btn-icon icon-left">
										查看成绩
									</a>
								</td>
							</tr>
...
<script type="text/javascript">
 ...
 function toStudentHistoryInfomationList(id){
     	$("#studentid").val(id);
        document.forms[0].action = "LookStudentSubjectHistoryInformation.action";
