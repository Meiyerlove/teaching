						...
						<form role="form" class="form-horizontal">								
							<div class="form-group-separator"></div>								
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control" name="classid" id="classid" onchange="getStudent();"> 
											<option value="">...</option>
										    <c:forEach items="${classList}" var="class_" varStatus="status">       
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									    <input name="absenceDate" id="absenceDate" class="Wdate" style="margin-top:3px;height:26px;" type="text" onClick="WdatePicker()" value="${exam.temp_var}"/>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="保存" onclick="doAddAbsence();">
									</div>
								</div>
...
function doAddAbsence(){
		var classid=$("#classid").val(),
			...
			document.forms[0].action = "DoAddAbsence.action";
