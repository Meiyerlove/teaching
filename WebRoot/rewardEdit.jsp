				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">修改奖励页面</h3>
						...
						<div class="panel-body">
							...
							<form role="form" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="sid" name="sid" value="${reward.sid}">
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">奖励事由</label>
									
									<div class="col-sm-10">
										<textarea class="form-control" id="reason" name="reason">${reward.reason }</textarea>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-10">
										...
										<input type="button" class="form-control" style="margin-left:600px;width:80px;background:#e4393c;color:white;margin-top:-32px;" id="field-6" value="保存" onclick="doRewardUpdate();">
									</div>
								</div>
								
								<div class="form-group-separator"></div>
								<input type="hidden" name="classid" id="classid" value="">
								<input type="hidden" name="rewardid" id="rewardid" value="${reward.id}">
							</form>
						</div>
					</div>
...
function logout(){
	...
	function doRewardUpdate() {
        ...
        alert('更新奖励成功');
		document.forms[0].action = "DoRewardUpdate.action";
		//alert('用户添加成功');
		document.forms[0].submit();
	}
</script>
